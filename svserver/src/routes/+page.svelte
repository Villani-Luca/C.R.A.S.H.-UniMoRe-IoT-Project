...
<div class="p-4 border-1 rounded-md bg-blue-200 m-2">
    ...
    <p>In the home page You can see the informations given by the devices connected at the network and analyze datas based on the range choosen</p>
</div>

<div>
<MapComponent devices={data.result}/>
</div>
